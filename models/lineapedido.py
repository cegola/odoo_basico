...
class lineapedido(models.Model):
    ...
    pedido_id = fields.Many2one('odoo_basico_celia.pedido',ondelete="cascade", required=True)
    # Os campos Many2many crean unha táboa na BD
    informacion_ids = fields.Many2many("odoo_basico_celia.informacion",string="Rexistro de Información",relation="odoo_basico_celia_lineapedido_informacion",
